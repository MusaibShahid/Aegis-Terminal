  ...
  return (
    <div className="flex flex-col h-full text-xs p-2 space-y-1.5">
      {templates.length === 0 ? (
        ...
        templates.map((t) => (
          <div key={t.id} className="glass-card rounded-lg p-2.5 group hover:bg-surface-hover transition-colors">
            <div className="flex items-center justify-between">
              <div>
                <div className="text-text-secondary text-[11px] font-medium">{t.name}</div>
