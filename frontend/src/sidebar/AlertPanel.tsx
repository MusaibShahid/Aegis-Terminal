      ...
      <div className="flex-1 overflow-y-auto">
        {alerts.length === 0 ? (
          <div className="flex flex-col items-center justify-center h-full text-gray-600 gap-2 p-4">
            ...
            <span className="text-xs text-gray-600">No alerts set</span>
          </div>
        ) : (
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <div className="flex items-center gap-1.5">
                      <span className="font-mono text-white/80 text-[11px]">{a.symbol}</span>
                    ...
                    {a.note && (
                      <div className="text-[9px] text-gray-600 mt-0.5">{a.note}</div>
                    )}
                  </div>
                </div>
                <button
